...
if __name__ == '__main__':
    ...
    config = config.training(use_critic=True,
                             ...
                             num_sgd_iter=8,
                             clip_param=0.1406,
                             vf_loss_coeff=0.6575,
                             entropy_coeff=0.000517261,
                             shuffle_sequences=True,
                             gamma=0.99,
                             model={"fcnet_hiddens": [256, 512, 512], "fcnet_activation": "tanh"},
    ...
    checkpoint_config = CheckpointConfig(num_to_keep=None, checkpoint_frequency=None, checkpoint_at_end=True)
