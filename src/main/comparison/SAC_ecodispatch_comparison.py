...
if __name__ == '__main__':
    ...
    register_env("EcoDispatchEnv-v0", lambda c: EcoDispatchEnv(**c))

    config = SACConfig()
    config = config.training(twin_q=True,
                             q_model_config={"fcnet_hiddens": [512, 512, 256], "fcnet_activation": "tanh"},
                             policy_model_config={"fcnet_hiddens": [256, 512], "fcnet_activation": "tanh"},
                             optimization_config={"actor_learning_rate": 0.00061950, "critic_learning_rate": 0.00048028, "entropy_learning_rate": 0.000361585},
                             tau=0.0831142,
                             initial_alpha=0.3416586,
