...
if __name__ == '__main__':
    ...
    config = config.exploration(explore=True, exploration_config={"type": "GaussianNoise", "stddev": 0.00701, "initial_scale": 1.0, "final_scale": 1.0})
