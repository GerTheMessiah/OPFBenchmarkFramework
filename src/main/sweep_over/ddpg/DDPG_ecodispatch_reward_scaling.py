...
if __name__ == '__main__':
    ...
    config = config.exploration(explore=True,
                                exploration_config={"type": "GaussianNoise", "stddev": 0.01, "initial_scale": 1.0, "final_scale": 1.0})
    ...
    config = config.environment(env=env_name,
                                env_config={"eval": False, "reward_scaling": tune.grid_search([1, 0.0025, 0.0005, 0.00025, 0.0001, 0.00005]), "add_act_obs": False},
