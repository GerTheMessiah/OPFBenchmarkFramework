...
if __name__ == '__main__':
    ...
    config = config.training(use_critic=True,
                             ...
                             lr=1e-4,
                             gamma=0.99,
                             model={"fcnet_hiddens": tune.grid_search([[256, 256], [512, 512], [256, 256, 256], [256, 512, 256], [512, 256, 512], [512, 512, 512]]), "fcnet_activation": "tanh"},
    ...
    config = config.evaluation(evaluation_interval=None, evaluation_duration=6720, evaluation_config={"explore": False, "env_config": {"eval": True, "reward_scaling": 1 / 40000, "add_act_obs": False}})
