...
if __name__ == '__main__':
    ...
    register_env("QMarketEnv-v0", lambda c: QMarketEnv(**c))
    ...
    config = config.training(twin_q=True,
                             ...
                             optimization_config={"actor_learning_rate": 3e-4, "critic_learning_rate": 3e-4, "entropy_learning_rate": tune.grid_search([5e-5, 1e-4, 3e-4, 7e-4, 1e-3])},
                             tau=0.005,
