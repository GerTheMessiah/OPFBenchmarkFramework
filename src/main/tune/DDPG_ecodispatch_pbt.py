...
if __name__ == '__main__':
    ...
    config = config.environment(env=env_name, env_config={"eval": False, "reward_scaling": 0.0001, "add_act_obs": False},
    ...
    config = config.evaluation(evaluation_interval=None, evaluation_duration=6720,
